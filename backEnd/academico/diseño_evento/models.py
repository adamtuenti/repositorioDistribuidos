...
letras = RegexValidator(r'[A-Z]', 'Solo se admiten letras mayusculas')
numeros = RegexValidator(r'^[0-9]*$', 'Solo se admiten numeros')

# Create your models here.
class Area(models.Model):
    codigo=models.CharField(unique=True, max_length=1, validators=[letras])
...
class Especialidad(models.Model):
     codigo=models.TextField(unique=True, validators=[numeros])
...
class DesignEvento(models.Model):
    ...
    cod_programa=models.TextField(null=True, blank=True)
