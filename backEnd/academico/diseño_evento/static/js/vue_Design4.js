const app=new Vue({
    ...
    methods:{
        getDisenos: function(){
            axios.get('/academico/diseño_evento/api/design/').then((response)=>{
        ...
        getAreas: function(){
            axios.get('/academico/diseño_evento/api/area/').then((response)=>{
        ...
        getEspecialidades: function () {
            axios.get('/academico/diseño_evento/api/especialidad/').then((response)=>{
        ...
        getTipoEvento: function () {
            axios.get('/academico/diseño_evento/api/tipoEvento/').then((response)=>{
        ...
        obtenerDesign:function() {
            axios.get('/academico/diseño_evento/api/design/?cod='+this.newDesign.codigo).then((response)=>{
        ...
        obtenerObjEsp:function(descripcion) {
            axios.get('/academico/diseño_evento/api/objetivoEspecifico/?desc='+descripcion).then((response)=>{
        ...
        obtenerUnidad:function(unidad) {
            axios.get('/academico/diseño_evento/api/unidad/?nom='+unidad).then((response)=>{
        ...
        guardarObjetivos:function () {
            for(let indexobj=0; indexobj < this.objEspecificos.length; indexobj++){
                ...
                this.realizarPost('/academico/diseño_evento/api/objetivoEspecifico/',this.objEspecificos[indexobj])
            }
        },
        guardarUnidades:function () {
            for (let index = 0; index < this.unidades.length; index++){
                ...
                this.realizarPost('/academico/diseño_evento/api/unidad/',this.unidades[index])
                this.objetivo_sub={}
            }  
        },
        guardarSubUnidad: function () {
            for (let indexuni = 0; indexuni < this.unidades.length; indexuni++){
                ...
                for (let indexlist = 0; indexlist < lista_obj.length; indexlist++){
                    ...
                    this.realizarPost('/academico/diseño_evento/api/subUnidad/',lista_obj[indexlist])
                    cont++
                }
                lista_obj=[]
                cont=1
        ...
        guardarRecurso:function () {
            for(let indexrec=0; indexrec < this.recursos.length; indexrec++){
                ...
                this.realizarPost('/academico/diseño_evento/api/recurso/',this.recursos[indexrec])
            }
        },
        guardarLectura:function () {
            for(let indexlec=0; indexlec < this.lecturas.length; indexlec++){
                ...
                this.realizarPost('/academico/diseño_evento/api/lectura/',this.lecturas[indexlec])
            }
        },
        guardarReferencia:function () {
            for(let indexref=0; indexref < this.referencias.length; indexref++){
                ...
                this.realizarPost('/academico/diseño_evento/api/referencia/',this.referencias[indexref])
            }  
        },
        createDesign: function() {
            axios.post('/academico/diseño_evento/api/design/',this.newDesign).then((response)=>{
                this.obtenerDesign();
