...
class EventoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'codigo_evento': forms.TextInput(attrs={'class':'form-control','readonly':True}),
            'nombre': forms.TextInput(attrs={'class':'form-control','readonly':True}),
            'tipo_evento': forms.TextInput(attrs={'class':'form-control','readonly':True}),
            'codigo_evento_padre': forms.Select(attrs={'class':'form-control'}),
            'nombre_evento_Padre': forms.TextInput(attrs={'class':'form-control','readonly':True}),
            'modalidad': forms.TextInput(attrs={'class':'form-control','readonly':True}),
            ...
            'duracion': forms.NumberInput(attrs={'class':'form-control','readonly':True}),
