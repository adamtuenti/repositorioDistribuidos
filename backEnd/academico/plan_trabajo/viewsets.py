...
class DisenoHijoEventoViewSet(viewsets.ModelViewSet):
    queryset = DisenoEvento.objects.filter(es_padre=False)
    serializer_class = DisenoHijoEventoSerializer

class DisenoPadreHijoViewSet(viewsets.ModelViewSet):
    queryset = DisenoPadreHijo.objects.all()
    serializer_class = DisenoPadreHijoSerializer
...
class ArchivoActividadViewSet(viewsets.ModelViewSet):
    queryset = ArchivoActividad.objects.all()
    serializer_class = ArchivoActividadSerializer
