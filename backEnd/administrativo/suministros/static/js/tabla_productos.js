...
function llenarFila(cantidad,precio,descuento,subtotal,producto){
    ...
    $("#tableProSum tr").each(function(){
        ...
        if($(sel).val()==producto && $(check).prop("checked") == false){
                    ...
                    $($(hijos[2]).find("input")).val(descuento);
    ...
    if(bandera){
        ...
        $("#id_productosuministro_set-"+(total-2)+"-descuento").val(descuento);
