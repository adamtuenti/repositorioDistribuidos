...
plan_trabajo_router.register(r'disenoHijo', DisenoHijoEventoViewSet)
plan_trabajo_router.register(r'disenoPadreHijo', DisenoPadreHijoViewSet)
...
plan_trabajo_router.register(r'archivoActividad',  ArchivoActividadViewSet)
...
participante_router.register(r'detalleparticipante',DetalleParticipanteViewSet)
participante_router.register(r'notificaciones',NotificacionesViewSet)
participante_router.register(r'sugerencias',SugerenciasViewSet)
