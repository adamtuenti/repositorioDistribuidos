...
class EspoltechForm(forms.ModelForm):
	class Meta:
		...
		widgets = {
			"año":forms.TextInput(attrs={'readOnly':True}),
			"centro_costos":forms.HiddenInput(),
			"version":forms.NumberInput(attrs={"type":"number"}),
			"active":forms.HiddenInput(),

			#ingresos total
			"total_ingresos":forms.NumberInput(attrs={"readonly":True}),
			"total_ingresos_ejec":forms.NumberInput(attrs={"readonly":True}),

			#gastos total
			"total_gastos":forms.NumberInput(attrs={"readonly":True}),
			"total_gastos_ejec":forms.NumberInput(attrs={"readonly":True}),
			...
			"fondo_autogest":forms.NumberInput(attrs={'class': "plan","data-toggle":"tooltip","data-placement":"left", "title":"Saldos de los centros de costos. Cabe indicar que estos valores deberán ser modificados una vez cerrado el ejercicio fiscal"}),
			...
			"dec_ter_sueldo":forms.NumberInput(attrs={'class': "plan","data-toggle":"tooltip","data-placement":"left", "title":"RMU/12"}),
			"dec_cua_sueldo":forms.NumberInput(attrs={'class': "plan","data-toggle":"tooltip","data-placement":"left", "title":"Salario Básico Unificado/12"}),
			"aporte_patronal":forms.NumberInput(attrs={'class': "plan","data-toggle":"tooltip","data-placement":"left", "title":"RMU*9,65%"}),
			"fondo_reserva":forms.NumberInput(attrs={'class': "plan","data-toggle":"tooltip","data-placement":"left", "title":"RMU*8,33%. Aplica para el personal que haya cumplido 12 meses de aportación continua al IESS​"}),
			...
			"iva":forms.NumberInput(attrs={'class': "plan","data-toggle":"tooltip","data-placement":"left", "title":"Debe hacerse el cálculo estimado del IVA de todos los gastos contemplados en el presente presupuesto, excepto los que gravan tarifa 0%"}),
			...
			"espol_ingresos":forms.NumberInput(attrs={'class': "plan"}),
			"fundespol_ingresos":forms.NumberInput(attrs={'class': "plan"}),


			# gastos capital
			# activos fijos
			"mobiliarios":forms.NumberInput(attrs={'class': "plan","data-toggle":"tooltip","data-placement":"left", "title":"DEBE INCLUIRSE TODO BIEN CUYO VALOR SEA IGUAL O SUPERIOR A $100"}),
			"maquinaria_equipos":forms.NumberInput(attrs={'class': "plan","data-toggle":"tooltip","data-placement":"left", "title":"DEBE INCLUIRSE TODO BIEN CUYO VALOR SEA IGUAL O SUPERIOR A $100"}),
			"vehiculos":forms.NumberInput(attrs={'class': "plan","data-toggle":"tooltip","data-placement":"left", "title":"DEBE INCLUIRSE TODO BIEN CUYO VALOR SEA IGUAL O SUPERIOR A $100"}),
			"herramientas_84":forms.NumberInput(attrs={'class': "plan","data-toggle":"tooltip","data-placement":"left", "title":"DEBE INCLUIRSE TODO BIEN CUYO VALOR SEA IGUAL O SUPERIOR A $100"}),
			"equipos_sist_paq_84":forms.NumberInput(attrs={'class': "plan","data-toggle":"tooltip","data-placement":"left", "title":"DEBE INCLUIRSE TODO BIEN CUYO VALOR SEA IGUAL O SUPERIOR A $100"}),
			"bienes_artisticos":forms.NumberInput(attrs={'class': "plan","data-toggle":"tooltip","data-placement":"left", "title":"DEBE INCLUIRSE TODO BIEN CUYO VALOR SEA IGUAL O SUPERIOR A $100"}),
			"libros_84":forms.NumberInput(attrs={'class': "plan","data-toggle":"tooltip","data-placement":"left", "title":"DEBE INCLUIRSE TODO BIEN CUYO VALOR SEA IGUAL O SUPERIOR A $100"}),
			"partes_repuestos_84":forms.NumberInput(attrs={'class': "plan","data-toggle":"tooltip","data-placement":"left", "title":"DEBE INCLUIRSE TODO BIEN CUYO VALOR SEA IGUAL O SUPERIOR A $100"}),
			...
			# gastos corrientes
			# gastos en personal 51
			"rem_unificadas_ejec":forms.NumberInput(attrs={'gasto':'Remuneraciones Unificadas (RMU)','class': "ejec"}),
			"h_ext_supl_ejec":forms.NumberInput(attrs={'gasto':'Horas Extraordinarias y Suplementarias','class': "ejec"}),
			"encargos_ejec":forms.NumberInput(attrs={'gasto':'Encargos','class': "ejec"}),
			"dec_ter_sueldo_ejec":forms.NumberInput(attrs={'gasto':'Decimotercer Sueldo (RMU/12)','class': "ejec"}),
			"dec_cua_sueldo_ejec":forms.NumberInput(attrs={'gasto':'Decimocuarto Sueldo  (Salario Básico Unificado/12) Para el 2019, fue $400','class': "ejec"}),
			"aporte_patronal_ejec":forms.NumberInput(attrs={'gasto':'Aporte Patronal  (RMU*9,65%)','class': "ejec"}),
			"fondo_reserva_ejec":forms.NumberInput(attrs={'gasto':'Fondo De Reserva   (RMU*8,33%). Aplica para el personal que haya cumplido 12 meses de aportación contínua al IESS','class': "ejec"}),
			"comp_desahucio_ejec":forms.NumberInput(attrs={'gasto':'Compensacion  por Desahucio','class': "ejec"}),
			"comp_vacaciones_ejec":forms.NumberInput(attrs={'gasto':'Compensación por Vacaciones','class': "ejec"}),
			"hp_director_ejec":forms.NumberInput(attrs={'gasto':'Honorarios Profesionales/ Director del Proyecto','class': "ejec"}),
			"hp_coordinador_ejec":forms.NumberInput(attrs={'gasto':'Honorarios Profesionales / Coordinadores','class': "ejec"}),
			"hp_expertos_ejec":forms.NumberInput(attrs={'gasto':'Honorarios Profesionales / Expertos (detallar el cargo)','class': "ejec"}),
			"hp_otros_ejec":forms.NumberInput(attrs={'gasto':'Honorarios Profesionales / Otros Cargos','class': "ejec"}),
			"hp_dict_clases_ejec":forms.NumberInput(attrs={'gasto':'Honorarios Profesionales / Dictado de Clases','class': "ejec"}),
			"ind_laborales_ejec":forms.NumberInput(attrs={'gasto':'Indemnizaciones  Labores','class': "ejec"}),

			# bienes y servicios de consumo
			"agua_ejec":forms.NumberInput(attrs={'gasto':'Agua Potable','class': "ejec"}),
			"energia_elec_ejec":forms.NumberInput(attrs={'gasto':'Energía Eléctrica','class': "ejec"}),
			"telecomunicaciones_ejec":forms.NumberInput(attrs={'gasto':'Telecomunicaciones','class': "ejec"}),
			"correo_ejec":forms.NumberInput(attrs={'gasto':'Servicio de Correo','class': "ejec"}),
			"trans_personal_ejec":forms.NumberInput(attrs={'gasto':'Transporte De Personal','class': "ejec"}),
			"impresion_ejec":forms.NumberInput(attrs={'gasto':'Edición, Impresión, Reproducción Y Publicaciones','class': "ejec"}),
			"publicidad_ejec":forms.NumberInput(attrs={'gasto':'Difusión, Información Y Publicidad','class': "ejec"}),
			"serv_seguridad_ejec":forms.NumberInput(attrs={'gasto':'Servicio Seguridad y Vigilancia','class': "ejec"}),
			"serv_aseo_ejec":forms.NumberInput(attrs={'gasto':'Servicios De Aseo','class': "ejec"}),
			"membresias_ejec":forms.NumberInput(attrs={'gasto':'Membresías','class': "ejec"}),
			"otros_serv_generales_ejec":forms.NumberInput(attrs={'gasto':'Otros Servicios Generales','class': "ejec"}),
			"pasajes_int_ejec":forms.NumberInput(attrs={'gasto':'Pasajes al Interior','class': "ejec"}),
			"pasajes_ext_ejec":forms.NumberInput(attrs={'gasto':'Pasajes al Exterior','class': "ejec"}),
			"viaticos_int_ejec":forms.NumberInput(attrs={'gasto':'Viáticos Y Subsistencias al Interior','class': "ejec"}),
			"viaticos_ext_ejec":forms.NumberInput(attrs={'gasto':'Viáticos Y Subsistencias al Exterior','class': "ejec"}),
			"edificios_ejec":forms.NumberInput(attrs={'gasto':'Edificios, Locales, residencias y Cableado Estructurado (Instalación, Mantenimiento y Reparaciones)','class': "ejec"}),
			"gastos_mant_mobil_ejec":forms.NumberInput(attrs={'gasto':'Gastos de Mantenimiento de Mobiliarios','class': "ejec"}),
			"gastos_mant_equipos_ejec":forms.NumberInput(attrs={'gasto':'Gastos de Mantenimiento de Maquinarias Y Equipos','class': "ejec"}),
			"gastos_mant_vehic_ejec":forms.NumberInput(attrs={'gasto':'Gastos de Mantenimiento de Vehículos','class': "ejec"}),
			"gastos_libros_ejec":forms.NumberInput(attrs={'gasto':'Gastos en Libros y Colecciones','class': "ejec"}),
			"otros_gastos_ejec":forms.NumberInput(attrs={'gasto':'Otros Gastos en Instalaciones, Mantenimiento y Reparaciones','class': "ejec"}),
			"arr_edificios_ejec":forms.NumberInput(attrs={'gasto':'Arrendamientos De Edificios, Locales Y Residencias','class': "ejec"}),
			"arr_mobiliarios_ejec":forms.NumberInput(attrs={'gasto':'Arrendamiento de Mobiliarios','class': "ejec"}),
			"arr_maquinaria_ejec":forms.NumberInput(attrs={'gasto':'Arrendamientos De Maquinarias Y Equipos','class': "ejec"}),
			"cont_estudios_ejec":forms.NumberInput(attrs={'gasto':'Contratación de Estudios e Investigaciones  (Subcontrataciones)','class': "ejec"}),
			"serv_capacitacion_ejec":forms.NumberInput(attrs={'gasto':'Servicio  de Capacitación','class': "ejec"}),
			"fiscalizacion_ejec":forms.NumberInput(attrs={'gasto':'Fiscalización E Inspecciones Técnicas (Subcontrataciones)','class': "ejec"}),
			"arr_equipos_ejec":forms.NumberInput(attrs={'gasto':'Arrendamiento de Equipos Informaticos','class': "ejec"}),
			"mant_equipos_info_ejec":forms.NumberInput(attrs={'gasto':'Mantenimiento y Reparación de Equipos y Sistemas Informaticos','class': "ejec"}),
			"serv_alimentacion_ejec":forms.NumberInput(attrs={'gasto':'Servicios de Alimentación*','class': "ejec"}),
			"gastos_vestimenta_ejec":forms.NumberInput(attrs={'gasto':'Gastos en Vestimenta, Uniformes, Prendas de Protección','class': "ejec"}),
			"combustible_ejec":forms.NumberInput(attrs={'gasto':'Combustibles Y Lubricantes','class': "ejec"}),
			"materiales_ofician_ejec":forms.NumberInput(attrs={'gasto':'Materiales De Oficina','class': "ejec"}),
			"materiales_aseo_ejec":forms.NumberInput(attrs={'gasto':'Materiales De Aseo','class': "ejec"}),
			"herramientas_53_ejec":forms.NumberInput(attrs={'gasto':'Herramientas','class': "ejec"}),
			"mat_impresion_ejec":forms.NumberInput(attrs={'gasto':'Materiales De Impresión, Fotografía, Reproducción','class': "ejec"}),
			"medicinas_ejec":forms.NumberInput(attrs={'gasto':'Medicinas y Productos Farmacéuticos','class': "ejec"}),
			"mat_laboratorio_ejec":forms.NumberInput(attrs={'gasto':'Materiales Para Laboratorio Y Uso Médico','class': "ejec"}),
			"mat_construccion_ejec":forms.NumberInput(attrs={'gasto':'Materiales De Construcción, Eléctricos, Plomería','class': "ejec"}),
			"mat_didacticos_ejec":forms.NumberInput(attrs={'gasto':'Materiales Didacticos','class': "ejec"}),
			"respuestos_ejec":forms.NumberInput(attrs={'gasto':'Repuestos y Accesorios','class': "ejec"}),
			"suministros_agrop_ejec":forms.NumberInput(attrs={'gasto':'Suministros para Actividades Agropecuaria, Pesca y Caza','class': "ejec"}),
			"otros_bienes_ejec":forms.NumberInput(attrs={'gasto':'Otros Bienes de Uso y Consumo Corriente','class': "ejec"}),
			"mobiliarios_bienes_ejec":forms.NumberInput(attrs={'gasto':'Mobiliarios (Bienes Muebles no Depreciables)','class': "ejec"}),
			"maquinaria_equipos_bienes_ejec":forms.NumberInput(attrs={'gasto':'Maquinarias y Equipos (Bienes Muebles no Dereciables)','class': "ejec"}),
			"equipos_sist_paq_53_ejec":forms.NumberInput(attrs={'gasto':'Equipos, Sistemas y Paquetes Informaticos','class': "ejec"}),
			"libros_53_ejec":forms.NumberInput(attrs={'gasto':'Libros y Colecciones','class': "ejec"}),
			"partes_repuestos_53_ejec":forms.NumberInput(attrs={'gasto':'Partes y Respuestos','class': "ejec"}),

			# otros gastos corrientes
			"iva_ejec":forms.NumberInput(attrs={'gasto':'Impuesto al Valor Agregado (debe hacerse el cálculo estimadodel IVA de todos los gastos contemplados en el presente presupuesto, excepto los que gravan tarifa 0%)','class': "ejec"}),
			"tasas_ejec":forms.NumberInput(attrs={'gasto':'Tasas Generales, Impuestos. Contribuciones, Permisos, Licencias y Patentes (incluye aporte 5*1000)','class': "ejec"}),
			"otros_imp_ejec":forms.NumberInput(attrs={'gasto':'Otros Impuestos, Tasas y Contribuyentes','class': "ejec"}),
			"seguros_ejec":forms.NumberInput(attrs={'gasto':'Seguros','class': "ejec"}),
			"comisiones_banc_ejec":forms.NumberInput(attrs={'gasto':'Comisiones Bancarias','class': "ejec"}),
			"devoluciones_ejec":forms.NumberInput(attrs={'gasto':'Devoluciones','class': "ejec"}),
			"otros_gastos_fin_ejec":forms.NumberInput(attrs={'gasto':'Otros Gastos Financieros','class': "ejec"}),

			# transferencias corrientes: aportaciones de acuerdo a lineamientos
			"espoltech_ep_ejec":forms.NumberInput(attrs={'gasto':'ESPOL-TECH E.P. 7% en base a los ingresos','class': "ejec"}),
			"part_espol_ejec":forms.NumberInput(attrs={'gasto':'PARTICIPACIÓN ESPOL 7% ó 28,13% en base a los ingresos','class': "ejec"}),
			"part_unidad_ejec":forms.NumberInput(attrs={'gasto':'PARTICIPACIÓN UNIDAD 11% en base a los ingresos','class': "ejec"}),
			"espol_ingresos_ejec":forms.NumberInput(attrs={'gasto':'ESPOL 10% en base a los ingresos','class': "ejec"}),
			"fundespol_ingresos_ejec":forms.NumberInput(attrs={'gasto':'FUNDESPOL 4.5% en base a los ingresos','class': "ejec"}),

			# gastos capital
			# activos fijos
			"mobiliarios_ejec":forms.NumberInput(attrs={'gasto':'Mobiliarios','class': "ejec"}),
			"maquinaria_equipos_ejec":forms.NumberInput(attrs={'gasto':'Maquinarias Y Equipos','class': "ejec"}),
			"vehiculos_ejec":forms.NumberInput(attrs={'gasto':'Vehículos','class': "ejec"}),
			"herramientas_84_ejec":forms.NumberInput(attrs={'gasto':'Herramientas','class': "ejec"}),
			"equipos_sist_paq_84_ejec":forms.NumberInput(attrs={'gasto':'Equipos, Sistemas Y Paquetes Informáticos','class': "ejec"}),
			"bienes_artisticos_ejec":forms.NumberInput(attrs={'gasto':'Bienes artísticos y culturales','class': "ejec"}),
			"libros_84_ejec":forms.NumberInput(attrs={'gasto':'Libros Y Colecciones','class': "ejec"}),
			"partes_repuestos_84_ejec":forms.NumberInput(attrs={'gasto':'Partes y Repuestos','class': "ejec"}),
