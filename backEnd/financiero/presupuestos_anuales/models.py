...
class Espoltech(models.Model):
	...
	#ingresos total
	total_ingresos= models.DecimalField(max_digits=10 ,decimal_places=2,default=Decimal('0.0'), blank=True, null=True, validators=[financiero.validaciones.validate_positivo]) 
	total_ingresos_ejec= models.DecimalField(max_digits=10 ,decimal_places=2,default=Decimal('0.0'), blank=True, null=True, validators=[financiero.validaciones.validate_positivo])

	#gastos total
	total_gastos= models.DecimalField(max_digits=10 ,decimal_places=2,default=Decimal('0.0'), blank=True, null=True, validators=[financiero.validaciones.validate_positivo])
	total_gastos_ejec= models.DecimalField(max_digits=10 ,decimal_places=2,default=Decimal('0.0'), blank=True, null=True, validators=[financiero.validaciones.validate_positivo])
	...
	espol_ingresos=models.DecimalField(max_digits=10 ,decimal_places=2,default=Decimal('0.0'), blank=True, null=True, validators=[financiero.validaciones.validate_positivo]) #58.01.03
	fundespol_ingresos=models.DecimalField(max_digits=10 ,decimal_places=2,default=Decimal('0.0'), blank=True, null=True, validators=[financiero.validaciones.validate_positivo]) #58.01.03
	...
	espol_ingresos_ejec=models.DecimalField(max_digits=10 ,decimal_places=2,default=Decimal('0.0'), blank=True, null=True, validators=[financiero.validaciones.validate_positivo]) #58.01.03
	fundespol_ingresos_ejec=models.DecimalField(max_digits=10 ,decimal_places=2,default=Decimal('0.0'), blank=True, null=True, validators=[financiero.validaciones.validate_positivo]) #58.01.03
