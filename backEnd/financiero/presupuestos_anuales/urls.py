...
urlpatterns = [
    ...
    path("casillerosEjecutados/", views.casillasEjecutado, name="casilleroEjecutados"),
    path("casillerosEjecutados_ingresos_aportaciones/", views.casillasEjecutado_ingresos_aportaciones, name="casilleroEjecutados_ingresos_aportaciones"),
    path("modal_actualizar/", views.modal_actualizar, name="modal_actualizar"),
