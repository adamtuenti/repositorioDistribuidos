...
urlpatterns = [
    ...
    path('ajax/load-modal-seguimiento-interesado',views.cargar_seguimiento,name='interesado_cargar_seguimiento'),
    path('nuevo/seguimiento-interesado/<pk>/',views.crear_seguimiento,name='interesado_nuevo_seguimiento'),
